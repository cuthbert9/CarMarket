      ...
      <div className=" sm:flex  m-5 h-full">
        <div className="  sm:m-2  w-[95vw] sm:w-[60vw] h-full">
          <div className="sm:m-2">
            <h1 className="text-3xl sm:mx-6 font-bold my-1 ">
              {carDetails.carName}
            </h1>
          ...
          <div className="shadow-2xl rounded-xl h-[15vh] m-3">
            ...
            <h1 className="mx-6 font-[cursive]">
              {carDetails?.additionalFeatures}
            </h1>
          </div>
        ...
        <div className=" m-2  sm:w-[30vw]">
          <div className=" m-3 rounded-xl shadow-2xl">
            ...
            <div className="justify-center flex">
              <h1 className="m-3 text-xl font-bold">${carDetails?.price}</h1>
            </div>
            <div className="flex justify-center ">
              <button className="bg-green-600 p-4 mx-4 rounded-xl hover:scale-105 duration-500 my-2 w-full flex items-center justify-center gap-2">
                Make an Offer
          ...
          <div className="  m-3  rounded-xl shadow-2xl">
            <h1 className="mx-3 text-lg font-bold text-center">
              Specifications
            </h1>
